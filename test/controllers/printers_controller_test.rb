...
class PrintersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create printer" do
    assert_difference('Printer.count') do
      post printers_url, params: { printer: { description: @printer.description, job_id: @printer.job_id, name: @printer.name, operator: @printer.operator } }
    end
  ...
  test "should update printer" do
    patch printer_url(@printer), params: { printer: { description: @printer.description, job_id: @printer.job_id, name: @printer.name, operator: @printer.operator } }
